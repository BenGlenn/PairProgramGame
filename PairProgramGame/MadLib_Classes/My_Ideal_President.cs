...
namespace PairProgramGame.NewFolder1
{
    class My_Ideal_President
    {
        ...
        private readonly MadLibUI _backToUi = new MadLibUI();
        ...
        public void MyIdealPresident()
        {
            ...
            Console.Write("Perfect! Now enter a Noun. Like Apple, Board, Bucket, or Canoe: ");
            ...
            Console.Write("We are almost done! Now enter a Place. Like Minnesota, Bathroom, Mejier, or Casino: ");
